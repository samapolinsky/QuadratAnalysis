...
# path to image
image_local ="MM2_LOW0_25MAY2022_context"
image_path = f"./Data/Context/{image_local}.jpg"
...
context = ("You are an ecology field assistant trained in quadrat-based land cover estimation on coastal lands in Southeastern Virginia."
           "Given a photo of a vegetation quadrat, outlined in red:"
           ...
           "- ONLY count species within the red outline, but you can use species outside it to add context to species types."
